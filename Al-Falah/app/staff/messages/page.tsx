      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
          <div className="p-4 border-b border-gray-200">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#97AE2C]/500 focus:border-transparent"
              />
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto">
                      ...
                      return (
                        <div
                          ...
                          className={`p-3 border rounded-lg cursor-pointer transition ${
                            isSelected
                              ? "bg-[#97AE2C]/50 border-[#97AE2C]/600"
                              : "bg-white border-gray-200 hover:bg-gray-50"
                          }`}
                        >
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-[#97AE2C]/100 rounded-full flex items-center justify-center flex-shrink-0">
                              <span className="text-[#97AE2C]/600 font-semibold text-sm">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2">
                                ...
                                {conv.unreadCount > 0 && (
                                  <span className="bg-[#97AE2C]/600 text-white text-xs font-semibold rounded-full px-1.5 py-0.5">
                                    {conv.unreadCount}
                                  </span>
                                )}
                              </div>
            ...
            {loading && (
              <div className="p-4 text-center">
                <Loader2 className="w-4 h-4 animate-spin mx-auto text-[#97AE2C]/600" />
              </div>
            )}
                    ...
                    .map((conversation) => {
                      ...
                      return (
                        <div
                          ...
                          className={`p-3 border rounded-lg cursor-pointer transition ${
                            isSelected ? "bg-[#97AE2C]/50 border-[#97AE2C]/600" : "bg-white border-gray-200 hover:bg-gray-50"
                          }`}
                        >
                          <div className="flex items-start justify-between">
                            ...
                            {conversation.unreadCount > 0 && (
                              <span className="ml-2 bg-[#97AE2C]/600 text-white text-xs font-semibold rounded-full px-1.5 py-0.5">
            ...
            <div className="flex-1 flex flex-col p-6">
              <div className="mb-4">
                <button
                  ...
                  className="text-[#97AE2C]/600 hover:text-[#97AE2C]/700 font-medium"
                >
                  ← Back
                </button>
              </div>
                      ...
                      return (
                        <div
                          ...
                          className={`p-4 border rounded-lg cursor-pointer transition ${
                            isSelected ? "bg-[#97AE2C]/50 border-[#97AE2C]/600" : 
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            {isSelected && <div className="text-[#97AE2C]/600">✓</div>}
                          </div>
                        </div>
                      )
                    })}
              ...
              <div className="mt-4">
                <button
                  ...
                  className="w-full px-4 py-2 bg-[#97AE2C]/600 text-white rounded-lg hover:bg-[#97AE2C]/700 transition font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >
                        ...
                        >
                          ...
                          >
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <span className={`text-xs ${isOwnMessage ? "text-[#97AE2C]/100" : "text-gray-500"}`}>
              ...
              <div className="bg-white border-t border-gray-200 p-4">
                <form onSubmit={handleSendMessage} className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#97AE2C]/500 focus:border-transparent"
                  />
                  <button
                    type="submit"
                    disabled={!newMessage.trim() || sending}
                    className="px-6 py-2 bg-[#97AE2C]/600 text-white rounded-lg hover:bg-[#97AE2C]/700 transition font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                  >
