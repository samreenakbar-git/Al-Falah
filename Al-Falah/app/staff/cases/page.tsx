...
export default function CasesPage() {
  ...
  // Redirect if no token and get user role
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const fetchCases = async () => {
      try {
        ...
        // For super admin, add tenantId filter if selected
        // For admin, API will automatically filter by their tenantId
        ...
        // Filter out old cases for super admin only
        if (userRole === "super_admin") {
                    ...
                    {caseItem.documents.map((doc, index) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="px-3 py-1 bg-[#97AE2C]/600 text-white rounded hover:bg-[#97AE2C]/700 text-xs font-medium"
                        >
                          View
                        </button>
                      </div>
...
//     )
//   return (
//     <div className="min-h-screen bg-gradient-to-b from-[#97AE2C]/50 to-blue-50">
//       <header className="bg-white border-b border-gray-200 px-8 py-6">
//         <div className="max-w-7xl mx-auto flex items-center justify-between">
//           <div className="flex items-center gap-3">
//             <div className="w-8 h-8 bg-[#97AE2C]/600 rounded-full flex items-center justify-center">
